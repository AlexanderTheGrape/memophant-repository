...
class userClass:
	...
	def logOnScreen(frame):
		...
		#userPasswords = ['user 1 is cool', 'user 2 is awesome', 'user 3 sucks']
		#enteredPassword = 
...
fileSubMenu.add_command(label="User 3", command=lambda: usableUserClass.chooseUser(frame, "User 3"))
...
editSubMenu.add_command(label="Change colour scheme", command=lambda: usableUserClass.restartProgram(frame))
