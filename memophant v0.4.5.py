...
def nextQuestion(frame, questionCounter, QsAndAs, sessionAnswerInfo):
	...
	if len(splitWordList) > 8:
		...
		answerButton = Button(frame, padx=32, pady=16, bd=8, text="Answer", fg="black", font='Calibri 12 bold', command= lambda: selfCheckAnswer(frame, questionCounter, QsAndAs, txtDisplay.get(), sessionAnswerInfo))
		answerButton.pack()
	else:
		#CHANGE THE FOLLOWING FUNCTION TO THE NEW MADE ONE
		checkButton = Button(frame, padx=32, pady=16, bd=8, text="Check answer", fg="black", font='Calibri 12 bold', command= lambda: checkAnswer(frame, questionCounter, QsAndAs, txtDisplay.get(), sessionAnswerInfo))
		checkButton.pack()

	mainMenuButton = Button(frame, padx=32, pady=16, bd=8, text="Main Menu", fg="black", font='Calibri 12 bold', command= lambda: listCompleteScreen(frame, questionCounter, QsAndAs, sessionAnswerInfo))
	mainMenuButton.pack()
...
def selfCheckAnswer(frame, questionCounter, QsAndAs, userAnswer, sessionAnswerInfo):
	...
	noButton = Button(frame, padx=32, pady=16, bd=8, text="No", fg="black", font='Calibri 12 bold', command= lambda: nextQuestion(frame, questionCounter, QsAndAs, sessionAnswerInfo))
	noButton.bind('<Return>', lambda event: nextQuestion(frame, questionCounter, QsAndAs, sessionAnswerInfo))
	noButton.pack()
	noButton.focus()

	yesButton = Button(frame, padx=32, pady=16, bd=8, text="Yes", fg="black", font='Calibri 12 bold', command= lambda: nextQuestion(frame, questionCounter, QsAndAs, sessionAnswerInfo))
...
def checkAnswer(frame, questionCounter, QsAndAs, userAnswer, sessionAnswerInfo):
	...
	answerButton = Button(frame, padx=32, pady=16, bd=8, text="Next", fg="black", font='Calibri 12 bold', command= lambda: nextQuestion(frame, questionCounter, QsAndAs, sessionAnswerInfo))
...
def instructionsPage(frame):
	...
	OkButton = Button(frame, padx=32, pady=16, bd=8, text="OK", fg="black", 
...
def askNewQuestion(frame, newFile, newFileText):
	...
	mainMenuButton = Button(frame, padx=32, pady=16, bd=8, text="Exit", fg="black", font='Calibri 12 bold', command= lambda: openMainMenu(frame))
	mainMenuButton.bind('<Escape>', lambda event: openMainMenu(frame))
	mainMenuButton.pack()
