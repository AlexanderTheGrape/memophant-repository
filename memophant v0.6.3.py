...
global currentUsername
class userClass:
	def addUserSubmenuOption(username):
		print('----got to here')
		fileSubMenu.add_command(label="%s" % username, command= lambda: setUser(username))
...
fileSubMenu.add_command(label="New user", command=lambda: print('...new user initiated'))
fileSubMenu.add_separator()
fileSubMenu.add_command(label="User 1", command=lambda: usableUserClass.addUserSubmenuOption("User 1"))
fileSubMenu.add_command(label="User 2", command=lambda: print('...new project 2 initiated'))
fileSubMenu.add_separator()
...
editSubMenu.add_command(label="Redo", command=lambda: print('edit button 1 pressed'))
